(final: prev: {
  vscode-extensions = prev.vscode-extensions // {
    # overrides
    vscodevim = prev.vscode-extensions.vscodevim // {
    ...
    jnoortheen = prev.vscode-extensions.jnoortheen // {
    ...
    bmalehorn = prev.vscode-extensions.bmalehorn // {
    ...
    # additions
    miguelsolorio = (prev.vscode-extensions.miguelsolorio or { }) // {
    ...
    yanivmo = (prev.vscode-extensions.yanivmo or { }) // {
    ...
    dnut = (prev.vscode-extensions.dnut or { }) // {
    ...
    vorg = (prev.vscode-extensions.vorg or { }) // {
    ...
    chadalen = (prev.vscode-extensions.chadalen or { }) // {
